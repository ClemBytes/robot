...
\begin{center}
\leavevmode
\includegraphics[width=190pt]{lib__server_8h__dep__incl}
\end{center}
\end{figure}
...
\hline
{\em x\+\_\+max} & Value max for x (so number of lines in the grid -\/ 1). \\
\hline
{\em y\+\_\+max} & Value max for y (so number of columns in the grid -\/ 1). \\
\hline
